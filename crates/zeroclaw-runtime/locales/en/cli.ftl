...
cli-quickstart-inkbox-intro = API-first email + SMS + voice + identity for one agent.
cli-quickstart-inkbox-has-key = Do you already have an Inkbox API key?
cli-quickstart-inkbox-provision-phone = Provision a local phone number? (unlocks SMS + voice)
cli-quickstart-inkbox-provisioned = ✓ provisioned
cli-quickstart-inkbox-provision-failed = could not provision a number:
cli-quickstart-inkbox-configured = ✓ Inkbox channel configured:
cli-quickstart-inkbox-signup-intro = We'll create a fresh agent identity for you via self-signup.
cli-quickstart-inkbox-email = Your email address (for verification)
cli-quickstart-inkbox-bad-email = A valid email address is required.
cli-quickstart-inkbox-handle = Desired agent handle (globally unique)
cli-quickstart-inkbox-signing-up = Calling agent-signup…
cli-quickstart-inkbox-signup-failed = signup failed:
cli-quickstart-inkbox-created = ✓ created
cli-quickstart-inkbox-mailbox = mailbox:
cli-quickstart-inkbox-code-sent = A 6-digit code was sent to
cli-quickstart-inkbox-code = Verification code (or 'resend')
cli-quickstart-inkbox-resent = ✓ Resent. Check
cli-quickstart-inkbox-resend-failed = resend failed:
cli-quickstart-inkbox-verified = ✓ verified
cli-quickstart-inkbox-bad-code = wrong code:
cli-quickstart-inkbox-paste-key = Paste your Inkbox API key (ApiKey_…)
cli-quickstart-inkbox-no-key = No key provided.
cli-quickstart-inkbox-whoami-failed = whoami failed:
cli-quickstart-inkbox-not-api-key = This wizard requires an API key, but the credential is a JWT.
cli-quickstart-inkbox-key-validated = ✓ Key validated. Scope:
cli-quickstart-inkbox-list-failed = could not list identities:
cli-quickstart-inkbox-no-identities = Key valid, but it sees no agent identities.
cli-quickstart-inkbox-agent-multi-a = Agent-scoped key returned
cli-quickstart-inkbox-agent-multi-b = identities; using the first.
cli-quickstart-inkbox-bound = This API key is bound to identity:
cli-quickstart-inkbox-pick-identity = Select the identity this gateway runs as
cli-quickstart-inkbox-key-bound = ✓ key validated for
cli-quickstart-inkbox-phone = phone:
cli-quickstart-inkbox-handle-failed = could not load that identity:
cli-quickstart-inkbox-signing-header = --- Webhook signing key ---
cli-quickstart-inkbox-signing-explain1 = Inkbox signs outbound webhooks with an HMAC over the body.
cli-quickstart-inkbox-signing-explain2 = Without the matching key, the gateway cannot verify inbound Inkbox traffic.
cli-quickstart-inkbox-have-signing = Do you already have an Inkbox signing key?
cli-quickstart-inkbox-paste-signing = Paste your Inkbox signing key
cli-quickstart-inkbox-signing-saved = ✓ Saved signing key. Signature verification enabled.
cli-quickstart-inkbox-signing-rotate1 = Minting a new key here rotates any existing key for your org.
cli-quickstart-inkbox-signing-rotate2 = Any other gateway using the old key will fail verification until updated.
cli-quickstart-inkbox-gen-signing = Generate a new signing key now?
cli-quickstart-inkbox-signing-generated = ✓ Generated and saved signing key. Signature verification enabled.
cli-quickstart-inkbox-signing-failed = could not create signing key:
cli-quickstart-inkbox-rt-header = --- OpenAI Realtime calls ---
cli-quickstart-inkbox-rt-explain1 = Realtime calls send raw phone audio to OpenAI Realtime.
cli-quickstart-inkbox-rt-explain2 = This requires an OpenAI API key with /v1/realtime permission.
cli-quickstart-inkbox-rt-found = Found an existing OpenAI API key in your environment.
cli-quickstart-inkbox-rt-none = No OpenAI API key was detected for Realtime.
cli-quickstart-inkbox-rt-enable = Use OpenAI Realtime API for phone calls?
cli-quickstart-inkbox-rt-disabled = Realtime disabled. Calls will use Inkbox STT/TTS.
cli-quickstart-inkbox-rt-paste = Paste your OpenAI API key for Realtime calls
cli-quickstart-inkbox-rt-skip = No OpenAI API key entered. Realtime disabled; calls will use Inkbox STT/TTS.
cli-quickstart-inkbox-rt-on = ✓ Realtime calls are enabled for this agent.
cli-quickstart-inkbox-alias = Alias for this Inkbox channel
cli-quickstart-inkbox-bad-alias = invalid alias:
cli-quickstart-inkbox-sms-header = --- SMS opt-in ---
cli-quickstart-inkbox-sms-text-start = Text START to
cli-quickstart-inkbox-sms-line1b = to enable SMS from this agent
cli-quickstart-inkbox-sms-line2 = to your phone. Do this from every phone you want to message it from.
cli-quickstart-inkbox-sms-waiting-header = --- Waiting for your START text ---
cli-quickstart-inkbox-sms-polling = Polling every 3s for an inbound START to
cli-quickstart-inkbox-sms-without = Without it, the agent cannot send outbound SMS to that phone later.
cli-quickstart-inkbox-sms-listening = Listening for START...
cli-quickstart-inkbox-sms-confirmed = ✓ Got it. SMS opt-in confirmed from
cli-quickstart-inkbox-sms-later-b = anytime to enable outbound SMS.
cli-quickstart-inkbox-imsg-header = --- iMessage ---
cli-quickstart-inkbox-imsg-explain1 = Inkbox can make this agent reachable over iMessage from your iPhone.
cli-quickstart-inkbox-imsg-explain2 = No number to provision — you connect through the Inkbox iMessage router.
cli-quickstart-inkbox-imsg-enable = Enable iMessage for this agent?
cli-quickstart-inkbox-imsg-enable-failed = could not enable iMessage:
cli-quickstart-inkbox-imsg-enabled = ✓ iMessage enabled for this agent.
cli-quickstart-inkbox-imsg-connect = Connect your iPhone to this agent now?
cli-quickstart-inkbox-imsg-router-failed = could not fetch the iMessage router:
cli-quickstart-inkbox-imsg-steps-intro = From your iPhone, in the Messages app:
cli-quickstart-inkbox-imsg-step1 = 1. Text
cli-quickstart-inkbox-imsg-step1b = to
cli-quickstart-inkbox-imsg-step2 = 2. Inkbox texts you back from the number now assigned to this agent.
cli-quickstart-inkbox-imsg-step3 = 3. Send any first message (e.g. "hi") in that NEW thread.
cli-quickstart-inkbox-imsg-only-after = The agent can only message you after you message it first.
cli-quickstart-inkbox-imsg-waiting-header = --- Waiting for your first iMessage ---
cli-quickstart-inkbox-imsg-polling = Polling every 3s for an inbound iMessage to this agent.
cli-quickstart-inkbox-imsg-listening = Listening for your first iMessage...
cli-quickstart-inkbox-imsg-later = Skipped. The agent replies over iMessage once you connect and message it.
cli-quickstart-inkbox-imsg-connected = ✓ Got it. First iMessage received from
cli-quickstart-inkbox-imsg-welcome = You're connected! This is your iMessage channel to your ZeroClaw agent. Anything you send here goes straight to the agent, and its replies show up right in this thread.
cli-quickstart-inkbox-imsg-welcome-sent = ✓ Sent a welcome message back on that thread.
cli-quickstart-inkbox-imsg-welcome-failed = could not send the welcome message:
