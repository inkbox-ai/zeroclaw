...
cli-quickstart-inkbox-not-api-key = This credential is not an API key (JWTs are not supported here).
cli-quickstart-inkbox-whoami-failed = could not validate the key:
cli-quickstart-inkbox-which-handle = Agent identity handle this gateway runs as
...
cli-quickstart-inkbox-paste-signing = Paste your Inkbox signing key (whsec_…)
cli-quickstart-inkbox-gen-signing = Generate a new Inkbox signing key now?
cli-quickstart-inkbox-signing-saved = ✓ signing key saved — signature verification on
cli-quickstart-inkbox-signing-failed = could not create signing key:
cli-quickstart-inkbox-rt-found = Found an OpenAI API key in your environment.
cli-quickstart-inkbox-rt-none = Realtime calls need an OpenAI API key with /v1/realtime access.
cli-quickstart-inkbox-rt-enable = Use OpenAI Realtime for phone calls?
cli-quickstart-inkbox-rt-paste = Paste your OpenAI API key for Realtime
cli-quickstart-inkbox-rt-skip = No key entered; Realtime left off (calls use Inkbox STT/TTS).
cli-quickstart-inkbox-rt-on = ✓ Realtime enabled (validated on the first call).
...
cli-quickstart-inkbox-sms-prompt = To send SMS from this agent, text START to
cli-quickstart-inkbox-sms-listening = Listening for your START text…
cli-quickstart-inkbox-sms-confirmed = ✓ SMS opt-in confirmed from
cli-quickstart-inkbox-sms-later = No START yet — text it anytime to enable SMS to
cli-quickstart-inkbox-imsg-enable = Make this agent reachable over iMessage?
...
cli-quickstart-inkbox-imsg-enabled = ✓ iMessage enabled. From your iPhone, in Messages:
cli-quickstart-inkbox-imsg-step1 = 1. Text
cli-quickstart-inkbox-imsg-step1b = to
cli-quickstart-inkbox-imsg-step2 = 2. Then send any message in the new thread it texts back.
cli-quickstart-inkbox-imsg-wait = Wait for your first iMessage now?
cli-quickstart-inkbox-imsg-listening = Listening for your first iMessage…
cli-quickstart-inkbox-imsg-later = No message yet — connect anytime from your iPhone.
cli-quickstart-inkbox-imsg-connected = ✓ Connected from
cli-quickstart-inkbox-imsg-welcome = You're connected to your ZeroClaw agent over iMessage. Send anything here and it replies in this thread.
